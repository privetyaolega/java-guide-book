package com.eis.conspect.java.patterns.structural.flyweight;

import com.eis.conspect.java.patterns.structural.flyweight.forest.Forest;
...
public class Runner {
    ...
    private final static int TREE_TYPES = 2;
